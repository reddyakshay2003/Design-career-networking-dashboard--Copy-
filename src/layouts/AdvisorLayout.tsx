...
export default function AdvisorLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-100/60 flex selection:bg-indigo-500/20 selection:text-slate-900 overflow-x-hidden">
      {/* Sidebar */}
      <aside
          ...
          {isExpanded ? (
            <div className="flex items-center gap-3 overflow-hidden">
              <div className="w-10 h-10 rounded-xl bg-slate-800 text-white flex items-center justify-center font-bold text-lg tracking-wider flex-shrink-0 border border-slate-700 shadow-inner">
                DC<span className="text-indigo-400">.</span>
              </div>
              <div className="truncate">
                <p className="font-extrabold text-white text-sm tracking-tight truncate">Docklands Connect</p>
                <p className="text-[11px] font-medium text-slate-400 truncate">Advisor Supreme Control</p>
              </div>
            </div>
          ) : (
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        <header className="h-20 bg-white border-b border-slate-200/80 px-8 flex items-center justify-between sticky top-0 z-20 shadow-xs">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-sm font-bold text-slate-700 tracking-wide uppercase">Advisor Supreme Command Environment</h1>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-indigo-900 text-white font-bold text-xs flex items-center justify-center shadow-sm">
              AD
            </div>
          </div>
        </header>
